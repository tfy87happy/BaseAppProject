...
static BOOL const KNeedSelectedTabbarIconScale = YES;
...
- (NSArray *)viewControllersForTabBar {
    SHViewController *firstViewController = [[SHViewController alloc] init];
...
//     [[UITabBar appearance] setBackgroundColor:[UIColor cyl_systemBackgroundColor]];
         ...
         [[UITabBar appearance] setBackgroundImage:[[self class] imageWithColor:[UIColor whiteColor] size:CGSizeMake([UIScreen mainScreen].bounds.size.width, (CYL_IS_IPHONE_X ? 65 : 40))]];
...
- (void)tabBarController:(UITabBarController *)tabBarController didSelectControl:(UIControl *)control {
    ...
    if (KNeedSelectedTabbarIconScale) {
